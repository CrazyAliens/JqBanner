    ...
    banner : function (mJson) {
        ...
        if ( type === "fade" ){
            ...
            if ( seamless ){
                ...
                $picUl.width(length*(width+10)).css("marginLeft",-width).parent().css("overflow" , "hidden");
                $pic = $picUl.children();
            }else{
                $picUl.width(length*(width+10)).parent().css("overflow" , "hidden");
            }
            $pic.css({
                width : width,
                position : "static",
        ...
        function change(i) {
            ...
            $tab.eq(index).css({background:"#fff"});
            index = i;
            if ( ifFade ){
            ...
            $tab.eq(index).css({ background: "#f40",});
        }
